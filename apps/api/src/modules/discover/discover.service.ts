...
不要追求完美。漏记了一天没关系，重要的是养成持续的习惯。AI米粒会帮你分析消费趋势，让记账变得有成就感。`,
...
### 第三步：在 Moona 中追踪
在 Moona 中设置对应的预算类别，AI米粒会自动帮你监控各项支出是否超标。
...
**先储蓄后消费**。发工资当天就把储蓄部分转走，用剩下的钱生活。这就是"支付给自己"的理念。`,
      ...
      },
      {
        ...
        summary: '学会在 Moona 中使用 AI米粒，让记账效率提升 10 倍。',
        content: `# AI 记账指南

## AI米粒 能做什么？

### 语音记账
直接对 AI米粒 说："午饭花了 35 元"，系统会自动识别金额、分类并记录。

### 智能分类
AI米粒会根据你的描述自动匹配最合适的消费分类，准确率超过 95%。

### 财务分析
问 AI米粒："这个月花了多少钱？"、"最大的支出是什么？"，即时获得分析结果。

### 预算建议
AI米粒会根据你的消费习惯，给出个性化的预算建议和省钱方案。
